...
choppSobra =  Number(prompt('Quanto de chopp foi sobrou? (litros) '))

choppBebido = totalLitrosChopp - choppDesperdicado - choppSobra
mediaLitrosPessoa = Number(((totalLitrosChopp - choppDesperdicado - choppSobra) / numeroConvidados).toFixed(3))
